# Generated by Django 3.0.5 on 2021-06-02 12:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.ImageField(default='defaultpic.jpg', upload_to='')),
                ...
                ('mobno', models.CharField(max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billtype', models.CharField(choices=[('subscriptions', 'subscriptions'), ('grocery', 'grocery'), ('products', 'products'), ('Other', 'Other')], default='Other', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plan', models.CharField(choices=[('Free Plan', 'Free Plan'), ('Basic Plan', 'Basic Plan'), ('Semi-Premium Plan', 'Semi-Premium Plan'), ('Premium Plan', 'Premium Plan')], max_length=100)),
                ('price', models.IntegerField(default=0)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='alloted',
            field=models.ManyToManyField(blank=True, related_name='Alloted_Users', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='dietplan',
            name='dinner',
