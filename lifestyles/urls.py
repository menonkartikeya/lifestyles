...
urlpatterns = [
    ...
    path('api/exerciseall/',exercise_view,name="exerciseallapi"),
    path('api/streak/',streak_view,name="streakapi"),
    path('api/steps/',steps_view,name="stepsapi"),
    path('api/live/',live_view,name="liveapi"),
